...
export const PassengerSettings: React.FC = () => {
  ...
  return (
    <div className="space-y-8 text-left select-none max-w-3xl">
      <PageHeader 
        title="Settings" 
        description="Configure your corporate commuter preferences and notification triggers."
      />
      ...
      <div className="space-y-6">
        ...
        <Card hoverEffect={false} className="border border-brand-border/40 p-6 space-y-4 bg-brand-card/25">
          <h4 className="text-xs font-bold text-brand-accent uppercase tracking-wider pb-2 border-b border-brand-border/30 flex items-center gap-2">
          ...
          <div className="space-y-4 text-xs text-brand-textMuted">
            <div className="flex justify-between items-center py-1 border-b border-brand-border/20 pb-3">
              <div>
                ...
                <p className="text-[10px] text-brand-muted mt-0.5">Toggle light mode or dark mode preferences.</p>
              </div>
              <Badge variant="accent">Dark Theme Active</Badge>
            </div>
            ...
            <div className="flex justify-between items-center py-1">
              <div>
                <p className="font-bold text-brand-text">Route Visibility</p>
        ...
        <p className="text-[10px] text-brand-muted text-center italic">
          Additional settings (OTP binding, ride alerts) will release in Sprint 5.
        </p>
      </div>
