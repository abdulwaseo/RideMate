  ...
  return (
    <div className="space-y-8 text-left select-none max-w-3xl">
      <PageHeader 
        ...
        description="Connect and coordinate in real-time with accepted carpool passengers."
      />
      ...
      <Card hoverEffect={false} className="border border-dashed border-brand-border p-12 text-center bg-brand-card/10 space-y-5">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-brand-textMuted max-w-sm mx-auto leading-relaxed">
            Direct instant messaging and group commuter coordinate chats are locked.
          </p>
        </div>

        <Badge variant="accent">Chat module will be implemented in Sprint 6</Badge>
      </Card>
    </div>
  );
};
